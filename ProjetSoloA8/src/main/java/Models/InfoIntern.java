...
public class InfoIntern implements Serializable {
    ...
    public InfoIntern(@Size(max = 255) String firstname, @Size(max = 255) String lastname, @Size(max = 255) String address, @Size(max = 65535) String skills, @Size(max = 65535) String linkedin, @Size(max = 255) String internGroup, Date birthday) {
