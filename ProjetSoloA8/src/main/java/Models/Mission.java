...
public class Mission implements Serializable {
    ...
    public Mission(Integer year, Date startMission, Date endMission, @Size(max = 255) String reportTitle, @Size(max = 65535) String commentsOfTheIntern, @Size(max = 65535) String midInternshipMeetingInfo, Boolean soutenance, @Size(max = 65535) String keyWord, EvalSheet eval_sheet, VisitSheet visit_sheet) {
        this.year = year;
